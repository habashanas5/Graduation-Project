...
namespace GraduationProject.Pages.VendorContactForm
{
    ...
    public class VendorContactFormModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync([Bind(Prefix = nameof(VendorContactForm))] VendorContactModel input)
        {
            ...
            if (action == "create")
            {
                ...
                return Redirect($"./FactoriesContactForm?rowGuid={newobj.RowGuid}&action=edit");
            }
            else if (action == "edit")
            {
                ...
                return Redirect($"./FactoriesContactForm?rowGuid={existing.RowGuid}&action=edit");
            }
            else if (action == "delete")
            {
                ...
                return Redirect("./FactoryContactList");
            }
            return Page();
        }
