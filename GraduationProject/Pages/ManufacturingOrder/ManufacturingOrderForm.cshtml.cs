    ...
    public class PurchaseOrderFormModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync([Bind(Prefix = nameof(PurchaseOrderForm))] PurchaseOrderModel input)
        {
            ...
            if (action == "create")
            {
                ...
                return Redirect($"./ManufacturingOrderForm?rowGuid={newobj.RowGuid}&action=edit");
            }
            else if (action == "edit")
            {
                ...
                return Redirect($"./ManufacturingOrderForm?rowGuid={existing.RowGuid}&action=edit");
            }
            else if (action == "delete")
            {
                ...
                return Redirect("./ManufacturingOrdersList");
            }
            return Page();
        }
